...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_2_3x5_3(
        KC_NO, 	KC_F1,	KC_F2,	KC_F3,  KC_F4,	KC_NO,            					KC_VOLU,    	KC_HOME,    KC_PGUP,	KC_NO,    	KC_NO,  KC_NO,
        KC_NO, 	KC_F5,	KC_F6, 	KC_F7,	KC_F8,	KC_PSCR,              				KC_LEFT,		KC_DOWN,   	KC_UP,  	KC_RGHT,	KC_INS,  KC_NO,
				KC_F9,	KC_F10, KC_F11, KC_F12,	KC_NO,              				KC_VOLD,    	KC_END,    	KC_PGDN,  	KC_NO,   	KC_NO,
    ...
    [SYM] = LAYOUT_2_3x5_3(
        KC_PLUS, 	KC_NO,   	KC_NO,	KC_NO,   	KC_NO,   	KC_NO,          KC_NO, 		KC_NO, 		KC_NO, 		KC_NO,  	KC_NO, 		KC_NO,
        KC_EQL,		KC_EXLM,   	KC_AT,	KC_HASH, 	KC_DLR,  	KC_PERC,        KC_CIRC,   	KC_AMPR,	KC_ASTR, 	KC_LPRN, 	KC_RPRN,  	KC_NO,
